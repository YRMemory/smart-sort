...
<p align="center">
  <img src="docs/images/02-team.png" alt="Участники проекта" width="700">
</p>
...
<table align="center">
  <tr>
    <td align="center" width="300">
      ...
      <br><br>
      <a href="https://github.com/USERNAME_1">
...
Система построена по принципу **толстого клиента**: основная часть логики и вычислительных процессов выполняется на пользовательском устройстве.
...
<p align="center">
  <img src="docs/images/07-sensors.png" alt="Работа с датчиками" width="850">
</p>
...
<p align="center">
  <img src="docs/images/08-app.png" alt="Разработанное приложение" width="850">
</p>
...
```text
Предмет отсортирован верно.
Спасибо за заботу об окружающей среде!
```
...
```text
Предмет помещён в неверный контейнер.
Проверьте рекомендацию системы и попробуйте снова.
```
...
<p align="center">
  <img src="docs/images/10-prototype.png" alt="Текущий вид системы" width="850">
</p>
